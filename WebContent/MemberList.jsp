...
<body>
	...
	<div id="page" style="padding-bottom: 0px">
		...
		<header id="gtco-header" class="gtco-cover gtco-cover-md"
			...
			<div class="gtco-container">
				<div class="row">
					<div class=" col-md-offset-0 text-left" style="font-size:3px;" >
						...
						<h1 style="text-align: center; margin-top: 110px">Member List</h1>
						<div class="row row-mt-15em" style="margin-right:130px;">
								...
								<div class="form-wrap"
									...
									<div class="tab">
										...
										<col width="0.1%">
										 ...
										 <tr style="color: white; font-size: 25px ; font-family: Roboto;" >  <td> UserId </td> <td> NickName </td><td> Location </td><td> Level </td><td colspan="2">Update </td></tr>
										<c:forEach items="${list }" var="list">
										<tr> <td> ${list.getUserId() } </td> 
										<td> ${list.getUserNickname() } </td>
											<td> ${list.getUserAdd() } </td>
											<td> ${list.getUserLevel() } </td>
											
											<td><c:if test="${list.getUserLevel() ne '2'}"> <button style="border-radius: 20px; background-color:#FBB448;" onclick="location.href='UserLevelUp?id=${list.getUserId()}&page=${paging.page }&value=up'"> <i class="icon-arrow-up" style="color: white"></i></button></c:if> </td>
											
											<td><c:if test="${list.getUserLevel() ne '0'}"> <button style="border-radius: 20px; background-color:#FBB448;" onclick="location.href='UserLevelUp?id=${list.getUserId()}&page=${paging.page }&value=down'"> <i class="icon-arrow-down" style="color: white"></i></button> </c:if></td>
										</tr>
										</c:forEach>
										</table>
							...
							<c:if test="${paging.page>1}">
								<a href="AllUserInfo?page=${paging.page-1}">이전</a>&nbsp;
							</c:if>
			...
			&nbsp;<a href="AllUserInfo?page=${paging.page+1}" id="a">다음</a>
							</c:if>
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-12 text-center">
						<div class="gtco-widget">
							...
							<ul class="gtco-quick-contact">
								<li><a href="#"><i class="icon-phone"></i>010 9525 1639
								</a></li>
								<li><a href="#"><i class="icon-mail2"></i>
							...
							<ul class="gtco-quick-contact">
								<li><a href="#"><i class="icon-phone"></i> 010 6615
										0501</a></li>
								<li><a href="#"><i class="icon-mail2"></i>
