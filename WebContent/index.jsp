			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div id="gtco-logo">
							<a href="index.jsp">New Folder <em>.</em></a>
						</div>
					</div>
					<div class="col-xs-8 text-right menu-1">
						<ul>
							...
							<li class="btn-cta"><a href="Loginindex.jsp"><span>Sign
										in</span></a></li>
									...
									<div class="tab">
										...
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												<h3 class="cursive-font">Sign-Up Now!</h3>
												<form action="regControll" method="post">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<label>NickName</label> <input type="text" id="NickName"
																...
																placeholder="type your NickName" name="nickname">
														</div>
													</div>
													<div class="row form-group">
														<div class="col-md-12">
															<label>Address</label> <input type="text" id="Address"
																class="form-control" required
																placeholder="type your Address" name="add">
														</div>
													</div>
													<div class="row form-group">
														<div class="col-md-12">
