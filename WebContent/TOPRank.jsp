			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading"
						style="height: 5vw;">
						<h2 class="cursive-font primary-color">Good dude you can do
							eat!</h2>
					</div>
				</div>
				<div class="row"
					...
					<div class="col-lg-4 col-md-4 col-sm-6 animate-box"
						...
						<div id="a" class="fh5co-card-item">
							<figure>
								<div class="overlay"></div>
								<div>
									<img id="left" src="${img}" alt="Image" class="img-responsive">
								</div>
							</figure>
							<div class="fh5co-text">

								<p>
									<span class="price cursive-font" id="leftWords">"${name}"</span>
								</p>
								<p>${description}</p>
		...
		<div class="gtco-section">
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading"
						style="height: 5vw;">
						<h2 class="cursive-font primary-color">We are also recommend
							these!</h2>
					</div>
				</div>
				<div class="row"
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animate-box"
							...
							<div id="a" class="fh5co-card-item">
								<figure>
									<div class="overlay"></div>
									<div>
										<img id="left" src="${i.getFileName()}" alt="Image" class="img-responsive">
									</div>
								</figure>
								<div class="fh5co-text">

									<p>
										<span class="price cursive-font" id="leftWords">"${i.storeName}"</span>
									</p>
									<p>${i.storeComment}</p>
									<p>
										<a href="#"><i class="icon-phone"></i>&nbsp;${i.storeTel}</a>
									</p>
