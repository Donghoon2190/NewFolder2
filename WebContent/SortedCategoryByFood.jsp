...
<body>
	...
	<div id="page">
		...
		<header id="gtco-header" style="height: 10vw;"
			class="gtco-cover gtco-cover-md" role="banner"
			style="background-image: url(images/img_bg_1.jpg)"
			data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="gtco-container" style="height: 10vw;">
				<div class="row">
					<div class="col-md-12 col-md-offset-0 text-left"></div>
				</div>
			</div>
		</header>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						<h2 class="cursive-font primary-color">
							No worry for the Menu<br>This is all you wanna need!
						</h2>
						<br> <br>
						<p>You can do eat!!</p>
						<a href="GetFoodsInfo?foodCode=${foodCode}"><input
							style="padding: 1.5rem 10rem;" type="button"
							value="I wanna try VS game for ${foodList.get(0).foCategory}"
				...
				<div class="row">
					...
					<c:forEach items="${foodList}" var="i">
						<div class="col-lg-4 col-md-4 col-sm-6 animate-box"
							...
							<a href="${i.foFileName}" class="fh5co-card-item image-popup">
								<figure>
									<div class="overlay">
									</div>
									<img src="${i.foFileName}" alt="Image" class="img-responsive">
								</figure>
								<div class="fh5co-text">
									<h2 class="cursive-font primary-color" style="font-size: 3rem;">${i.foName}</h2>
									<p>${i.foComment}</p>
								</div>
							</a>
						</div>
