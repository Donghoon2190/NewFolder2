					...
					<div class="col-md-12">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="sr-only" for="name">Name</label> <input
											...
											placeholder="Your storename" name="name">
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<textarea name="comment" style="resize: none;" id="message"
											...
											placeholder="Description your Store"></textarea>
									</div>
								</div>
						...
						<div class="col-md-5 col-md-push-1 animate-box">
							...
							<div class="gtco-contact-info">
								<h3>Insert More Infomation</h3>
								<br>
								<ul>
									<li class="phone"><label class="sr-only" for="name">Name</label>
										<input type="text" maxlength="11" style="height: 2.5vw;" id="tel"
										class="form-control" required placeholder="Tel number"
										name="tel"></li>

									<li class="url"><label class="sr-only" for="name">Name</label>
										<select name="foods" id="foods" required>
											<option value="01">Korean</option>
											<option value="02">Western</option>
											<option value="03">Chinese</option>
											<option value="04">Asian</option>
											<option value="05">FastFoods</option>
											<option value="06">Dessert</option>
									</select></li>
									<li class="address"><label class="sr-only" for="name">Name</label>
										<input type="button" onclick="sample4_execDaumPostcode()"
										class="btn btn-primary" value="find your adress"><br>
									<br> <input type="text" id="sample4_roadAddress"
										style="height: 2.5vw;" id="name" class="form-control" required
										placeholder="도로명 주소" name="add"><br> <span
										id="guide" style="color: #999; display: none"></span> <input
										type="text" id="sample4_detailAddress" style="height: 2.5vw;"
										id="name" class="form-control" required placeholder="상세 주소"><br>
