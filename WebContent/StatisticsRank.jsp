...
<body>
	...
	<div id="page">
		...
		<div class="gtco-section" style="text-align: center;">
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading"
						...
						<p>Thanks for the vote of your taste</p>
							</div>
				</div>
				<br> <br>
			<c:if test="${my eq false}">
			<div style="margin-bottom: 300px;">
				<h3 class="cursive-font primary-color" style="font-size: 50px;"> You haven't selected<span style="color:  rgb(158, 226, 255)"> any foods . .</span></h3>
			</div>
			</c:if>

				<div class="row"
					style="justify-content: center; align-items: center; display: flex;">
					<c:forEach items="${foods}" var="i">
					<c:if test="${i.foState eq 'M'}">
						<div class="col-lg-4 col-md-4 col-sm-6 animate-box"
							...
							<div id="a" class="fh5co-card-item">
								...
								<div class="fh5co-text">
									...
									<p>${i.foComment}</p>
									<p style="color:rgb(230,230,230);">you picked it at <br>${i.foCode}</p>
		...
		<c:if test="${all eq false}">
				<h3 class="cursive-font primary-color" style="font-size: 50px;"> No one Play the Game <span style="color:  rgb(158, 226, 255)"> Today . .</span></h3>
			</c:if>
				<div class="row"
					style="justify-content: center; align-items: center; display: flex;">
					<c:forEach items="${foods}" var="i">
					<c:if test="${i.foState eq 'T'}">
						<div class="col-lg-4 col-md-4 col-sm-6 animate-box"
							style="cursor: pointer;">
							<div id="a" class="fh5co-card-item">
								<figure>
